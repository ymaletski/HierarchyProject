...
public class SchoolDAO extends GeneralSystemsDAO implements IDAOSchool {
	...
	public void record(School school, int addressId) {		
		...
		try {		
			...
			LOGGER.error("SQLException in SchoolDAO.record(): ", e);
		} finally {
	...
	public void deleteByName(School school) {		
		...
		try {			
			...
			LOGGER.error("SQLException in SchoolDAO.deleteByName(): ", e);
		} finally {
			closePreparedStatement(preparedStatement);
		}		
	}
	...
	public void deleteById(int id) {	
		...
		try {		
			...
			LOGGER.error("SQLException in SchoolDAO.deleteById(): ", e);
		} finally {
			closePreparedStatement(preparedStatement);
		}	
	}
	...
	public School findById(int id) {		
		...
		try {		
			...
			LOGGER.error("SQLException in SchoolDAO.findById(): ", e);
		} finally {
			if (resultSet != null) 
				try { 
					resultSet.close(); 
	...
	public int findIdByName(School school) {	
		...
		try {		
			...
			LOGGER.error("SQLException in SchoolDAO.findIdByName(): ", e);
		} finally {
			if (resultSet != null) 
				try { 
					resultSet.close(); 
	...
	public ArrayList<School> getAllData() {		
		...
		try {	
			...
			LOGGER.error("SQLException in SchoolDAO.getAllData(): ", e);
		} finally {
			if (resultSet != null) 
				try { 
					resultSet.close(); 
	...
	public int findAddressIdByName(School school) {		
		...
		try {			
			...
			LOGGER.error("SQLException in SchoolDAO.findAddressIdByName(): ", e);
		} finally {
			if (resultSet != null) 
				try { 
					resultSet.close(); 
